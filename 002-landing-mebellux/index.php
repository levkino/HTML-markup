...
<div class="page">
    ...
    <header class="header">
        ...
        <div class="header__main-text">
            ...
            <a href="#" class="header__button ftco-animate">
        ...
        <section class="info" id="section-info">
            ...
            <div class="info__container">
                <div class="info__indicators">
                    <div class="info__header ftco-animate">Наши показатели</div>
                    <div class="info__items">
                        <div class="info__item ftco-animate">
                            <span class="info__item-digit">800</span>
                            <span class="info__item-name">Созданных проектов</span>
                            <div class="info__item-line info__item-line_1"></div>
                        </div>
                        <div class="info__item ftco-animate">
                            <span class="info__item-digit">795</span>
                            <span class="info__item-name">Счастливых клиентов</span>
                            <div class="info__item-line info__item-line_2"></div>
                        </div>
                        <div class="info__item ftco-animate">
                            <span class="info__item-digit">1200</span>
                            <span class="info__item-name">рабочих часов</span>
                            <div class="info__item-line info__item-line_3"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row d-flex justify-content-end">
                    <div class="col-md-7 req-quote d-md-flex py-5 align-items-center img" style="background-image: url(images/bg_1.jpg);">
                        <p><a href="#" class="btn btn-white index-btn py-4 px-4" data-toggle="modal" data-target="#modalRequest">Начни сейчас</a></p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row d-md-flex contacts-row">
                    ...
                    <div class="col-md-8 ftco-animate">
                        <form class="application">
                            ...
                            <button class="application__send">Отправить заявку</button>
                        </form>                        
                    </div>
                </div>
            </div>
