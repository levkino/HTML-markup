...
$sql = "SELECT * FROM potolkiv_mebel.product where category='$pageName' ORDER BY id DESC ";
$per_page_html = '';
$page = 1;
$start=0;
if(!empty($_GET["num"])) {
    ...
    if($page_count>1) {
        for($i=1;$i<=$page_count;$i++){
            if($i==$page){
                ...
                $per_page_html .= '<a href="?page=' . $_GET['page'] . "&num=" . $i . '" class="btn-page">' . $i . '</a>';
            }
        }
    }
    $per_page_html .= "</div>";
    ...
    <div id="colorlib-page">
        ...
        where product_id = :id";
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <a href="tovar.php?tovar=<?=$productLol['id']?>" class="portfolio ftco-animate">
                                    ...
                                    <div class="d-flex heading align-items-end">
                                        <h3>
                                            <?=$pageName?> "<?=$productLol['productName']?>"
                                        </h3>
                                    </div>
                                    <img src="<?=$productLol['productImg']?>" class="img-fluid" alt="Colorlib Template">
                                </a>
                            </div>
                        <?}?>
                    </div>
